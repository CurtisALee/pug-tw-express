...
[ExpressJS] [ExpressJS]: This is the framework used to configure our project, holding everything together by making sure the correct files and assets are being served.
...
As a designer, I'm always fascinated by the technoligies behind what we design! That's why I thought it would be cool to build this. I actually have ChatGPT, and a couple of engineering wizards to thank for helping me solve the occassional bugs... The rise in AI Agents though will definitely help bridge the gap between designers and developers even more; as I've seen with this project!
